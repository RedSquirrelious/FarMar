...
#MARKET SPECS
	...
	it 'Must Return the List of Vendors at a Given Market' do
		...
		elmer_fudd = bugs_bunny[10]
		yosemite_sam = FarMar::Vendor.all?
		expect( yosemite_sam ).must_include(elmer_fudd.vendors)
	end
...
# 	# 	FarMar::Product.new({id: 789, name: "Thingamajig", vendor_id: 1001} )
...
# 		FarMar::Sale.new({id: 789, amount: 25, purchase_time: 1200, vendor_id: 1001, product_id: 789})
# 		expect( FarMar::Sale.all?.length ).wont_equal(0)
# 	end

# 	# it 'Must Look Up the Amount of a Sale if Given an ID' do
# 	# 	FarMar::Sale.new({id: 1953, amount: 25, purchase_time: 1200, vendor_id: 1001, product_id: 789})
...
# 		FarMar::Vendor.new({id: 1001, name: "Stuff and Things LLC", num_of_employees: 2, market_id: 123})
